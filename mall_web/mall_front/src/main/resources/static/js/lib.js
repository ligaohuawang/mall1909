...
(function ($) {
    $.fn.jdThickBox = function (option, callback) {
        ...
        var reposi = function () {
            ...
            if ($.browser.isIE6) {
                var ow = $(".thickbox").outerWidth(), oh = $(".thickbox").outerHeight();
        ...
        var init = function (data) {
            ...
            var createHtml = function () {
                ...
                $.each(s.pros, function (i) {
                    var id = s.pros[i].id, tp = s.pros[i].tp,
                        zt = (s.pros[i].zt == 1) ? "<div class='pi9'></div>" : "<div class='pi10'></div>",
                        mc = unescape(s.pros[i].mc), qg = s.pros[i].qg, zk = "(" + s.pros[i].zk + "��)";
